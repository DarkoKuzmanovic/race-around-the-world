      ...
      <div className="neo-card w-full max-w-xl relative">
        ...
        <div className="space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label htmlFor="p1Name" className="block text-sm font-bold uppercase mb-2 border-b-2 border-neo-black w-fit">
                Player 1 Name
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="p2Name" className="block text-sm font-bold uppercase mb-2 border-b-2 border-neo-black w-fit">
                Player 2 Name
              </label>
              <input
                type="text"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label htmlFor="start" className="block text-sm font-bold uppercase mb-2 border-b-2 border-neo-black w-fit">
                Start Location
              </label>
            ...
            <div>
              <label htmlFor="end" className="block text-sm font-bold uppercase mb-2 border-b-2 border-neo-black w-fit">
                Destination
              </label>
              <div className="relative">
                <select
        ...
        {pathLength > 0 && (
          <div className="text-center mt-8 p-4 bg-neo-blue/20 border-2 border-neo-black border-dashed">
            <p className="text-lg font-neo-body">
              Race Length: <span className="font-bold text-2xl">{pathLength}</span> Questions
            </p>
          </div>
        )}
        ...
        <button
          onClick={handleStart}
          className="neo-btn neo-btn-primary w-full mt-8 text-xl"
        >
          Start Race!
        </button>
      </div>
